{
	...
	"Public": "Public",
	"Private": "Private",
	"Unexpected token / in JSON at position 791": "Unexpected token / in JSON at position 791",
	"Cannot read properties of undefined (reading 'length')": "Cannot read properties of undefined (reading 'length')",
	"BackOffice": "BackOffice",
	"Customized": "Customized",
	"customized": "customized",
	"Failed to lookup view \"customed\" in views directory \"F:\\5.(인슈)LocalWeb_WIKI\\openKB\\views\\\"": "Failed to lookup view \"customed\" in views directory \"F:\\5.(인슈)LocalWeb_WIKI\\openKB\\views\\\"",
	"Permalink already exists. Pick a new one.": "Permalink already exists. Pick a new one.",
	"도메인등록": "도메인등록",
	"게시물발행(등록o)": "게시물발행(등록o)",
	"초안작성(등록X)": "초안작성(등록X)",
	"','콤마를 통해 키워드를 작성(such as hashtag)": "','콤마를 통해 키워드를 작성(such as hashtag)",
	",(comma)를 통해 키워드를 작성(such as hashtag)": ",(comma)를 통해 키워드를 작성(such as hashtag)",
	"퍼머링크작성 후 확인하기": "퍼머링크작성 후 확인하기",
	"퍼머링크 확인": "퍼머링크 확인",
	"Keywords(검색할단어)": "Keywords(검색할단어)",
	"제안하기(관리자 승인시 등록)": "제안하기(관리자 승인시 등록)",
	"View count successfully reset to zero.": "View count successfully reset to zero.",
	"Vote count successfully reset to zero.": "Vote count successfully reset to zero.",
	"기사제목": "기사제목",
	"Successfully saved2": "Successfully saved2",
	"Parse error on line 67:\n...-for=\"item in 2\" >{{search_api[item]}} <\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'": "Parse error on line 67:\n...-for=\"item in 2\" >{{search_api[item]}} <\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'",
	"Parse error on line 67:\n...-for=\"item in 2\" >{{search_api[0]}} </v-\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'": "Parse error on line 67:\n...-for=\"item in 2\" >{{search_api[0]}} </v-\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'",
	"Parse error on line 67:\n... in search_data\" >{{item[0]}} </v-btn>\r\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'": "Parse error on line 67:\n... in search_data\" >{{item[0]}} </v-btn>\r\n-----------------------^\nExpecting 'ID', 'STRING', 'NUMBER', 'BOOLEAN', 'UNDEFINED', 'NULL', 'DATA', got 'INVALID'",
	"customized1": "customized1",
	" Search the knowledge base": " Search the knowledge base",
	" ,(comma)를 통해 키워드를 작성(such as hashtag)": " ,(comma)를 통해 키워드를 작성(such as hashtag)",
	" 퍼머링크작성 후 확인하기": " 퍼머링크작성 후 확인하기",
	"Parse error on line 28:\n...v>\r                {{/ifCond}}\r       \n----------------------^\nExpecting 'EOF', got 'OPEN_ENDBLOCK'": "Parse error on line 28:\n...v>\r                {{/ifCond}}\r       \n----------------------^\nExpecting 'EOF', got 'OPEN_ENDBLOCK'",
	"Link": "Link",
	"All unused files have been removed": "All unused files have been removed",
	"Parse error on line 55:\n...                    {{/ifCond}}\r       \n-----------------------^\nExpecting 'EOF', got 'OPEN_ENDBLOCK'": "Parse error on line 55:\n...                    {{/ifCond}}\r       \n-----------------------^\nExpecting 'EOF', got 'OPEN_ENDBLOCK'",
	"새로운 article 생성완료": "새로운 article 생성완료",
	"Top 10 articles(Views)": "Top 10 articles(Views)",
	"변경내용이 저장되었습니다.": "변경내용이 저장되었습니다.",
	"db.kb.expectedDocumentCount is not a function": "db.kb.expectedDocumentCount is not a function",
	"Cannot read properties of undefined (reading 'estimatedDocumentCount')": "Cannot read properties of undefined (reading 'estimatedDocumentCount')",
	"Cannot read properties of undefined (reading 'countDocuments')": "Cannot read properties of undefined (reading 'countDocuments')",
	"db.kb.coun is not a function": "db.kb.coun is not a function",
	"Parse error on line 5:\n...    <title>{{result.kb_seo_title+'test1'\n-----------------------^\nExpecting 'ID', got 'INVALID'": "Parse error on line 5:\n...    <title>{{result.kb_seo_title+'test1'\n-----------------------^\nExpecting 'ID', got 'INVALID'",
	"alert is not defined": "alert is not defined",
	"Parse error on line 55:\n...b_body}}}  {{{ JSON.stringify(config.set\n-----------------------^\nExpecting 'ID', got 'INVALID'": "Parse error on line 55:\n...b_body}}}  {{{ JSON.stringify(config.set\n-----------------------^\nExpecting 'ID', got 'INVALID'",
	"index.forEach is not a function": "index.forEach is not a function",
	"top_results is not defined": "top_results is not defined",
	"Error": "Error",
	"frm_kb_permalink is not defined": "frm_kb_permalink is not defined",
	"중복된 Title입니다.": "중복된 Title입니다.",
	"Failed to lookup view \"200\" in views directory \"D:\\5.(인슈)LocalWeb_WIKI\\5.(인슈)LocalWeb_WIKI\\2023_01_12\\openKB\\openKB\\views\\\"": "Failed to lookup view \"200\" in views directory \"D:\\5.(인슈)LocalWeb_WIKI\\5.(인슈)LocalWeb_WIKI\\2023_01_12\\openKB\\openKB\\views\\\"",
	"Failed to save. Please try again": "Failed to save. Please try again",
	"doc is not defined": "doc is not defined",
	"Invalid status code: 63e042ddc974fd0cb4726e71": "Invalid status code: 63e042ddc974fd0cb4726e71",
	"Cannot set headers after they are sent to the client": "Cannot set headers after they are sent to the client",
	"Invalid status code: 63e042f1c974fd0cb4726e72": "Invalid status code: 63e042f1c974fd0cb4726e72",
	...
	"keywords.split is not a function": "keywords.split is not a function",
	"Successfully saved1": "Successfully saved1",
	"이전에 저장된 버전": "이전에 저장된 버전",
	"저장된 날짜": "저장된 날짜",
	"삭제하기": "삭제하기",
	"불러오기": "불러오기",
	"미리보기": "미리보기",
